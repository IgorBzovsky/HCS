    ...
    public partial class Initialdatamodel : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ProvidedUtilities", x => new { x.ProviderId, x.UtilityId });
                    table.ForeignKey(
                        name: "FK_ProvidedUtilities_Providers_ProviderId",
                        column: x => x.ProviderId,
                        principalTable: "Providers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ProvidedUtilities_Utilities_UtilityId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ProvidedUtilities_UtilityId",
