...
namespace HCS.Data.Migrations
{
    ...
    [Migration("20180315134140_Add Consumer categories")]
    partial class AddConsumercategories
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HCS.Core.Domain.HouseholdCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HCS.Core.Domain.OrganizationCategory", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd();
            ...
            modelBuilder.Entity("HCS.Core.Domain.Household", b =>
                {
                    b.HasOne("HCS.Core.Domain.HouseholdCategory", "HouseholdCategory")
                        .WithMany()
            ...
            modelBuilder.Entity("HCS.Core.Domain.Organization", b =>
                {
                    b.HasOne("HCS.Core.Domain.OrganizationCategory", "OrganizationType")
                        .WithMany()
