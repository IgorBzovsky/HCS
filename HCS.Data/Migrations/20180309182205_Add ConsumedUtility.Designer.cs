...
namespace HCS.Data.Migrations
{
    ...
    [Migration("20180309182205_Add ConsumedUtility")]
    partial class AddConsumedUtility
    {
            ...
            modelBuilder.Entity("HCS.Core.Domain.ConsumedUtility", b =>
                {
                    ...
                    b.Property<int?>("ProvidedUtilityProviderId");

                    b.Property<int?>("ProvidedUtilityUtilityId");

                    b.HasKey("ProvidedUtilityId", "ConsumerId");

                    b.HasIndex("ConsumerId");

                    b.HasIndex("ProvidedUtilityProviderId", "ProvidedUtilityUtilityId");
            ...
            modelBuilder.Entity("HCS.Core.Domain.ConsumedUtility", b =>
                {
                    ...
                    b.HasOne("HCS.Core.Domain.ProvidedUtility", "ProvidedUtility")
                        .WithMany()
                        .HasForeignKey("ProvidedUtilityProviderId", "ProvidedUtilityUtilityId");
                });
